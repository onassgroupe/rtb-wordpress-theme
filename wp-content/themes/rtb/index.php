...
<div class="rtb-page-head">
	<div class="rtb-container">
		<div class="rtb-eyebrow rtb-eyebrow--red"><i></i><span><?php echo esc_html( rtb_t( 'ACTUALITÉS' ) ); ?></span></div>
...
<?php if ( have_posts() ) : ?>
	<div class="rtb-archive-grid">
		<h2 class="rtb-visually-hidden"><?php echo esc_html( rtb_t( 'Articles' ) ); ?></h2>
...
<?php else : ?>
	<div class="rtb-archive-grid"><p><?php echo esc_html( rtb_t( 'Aucun article pour le moment.' ) ); ?></p></div>
<?php endif; ?>
