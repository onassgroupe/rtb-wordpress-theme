...
add_action( 'init', static function (): void {
	...
	$plugins = [
		...
		'rtb-liveblog/rtb-liveblog.php',
		// rtb-2fa : activation MANUELLE volontaire (plugin d'authentification sensible
		// — la RTB l'active depuis Extensions une fois SMTP + SMS configurés).
